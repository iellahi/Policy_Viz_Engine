---
title: "Budget Pipeline: Waterfall Chart"
...
params:
  # Master Data Path
  data_path: "../1_data/master_budget_pipeline.csv"
...
ggplot(plot_data, aes(fill = Type)) +
  ...
  geom_segment(data = plot_data %>% filter(Type != "End"),
               ...
               linetype = "dashed", color = cerp_cols["dark"]) +
  ...
  scale_fill_manual(values = c(
    ...
    "Deduction" = "#D7191C",  # Alert Red
    "Addition"  = "#ABD9E9"   # Soft Blue
  )) +
  ...
  labs(
    title = paste("Pipeline Breakdown:", params$metric_name),
    subtitle = "Tracking total allocations against systemic reductions to determine final delivery.",
    x = NULL,
    y = params$metric_name,
